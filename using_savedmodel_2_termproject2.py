...
new_model = tensorflow.keras.models.load_model('model-4convolayers.h5')
...
print("Predicted class of random testimage is:", classes)
...
# Gets the output from top 6 layers which includes 4 convolution layers, and 2 max pooling layers
outputs_from_layers = [layer.output for layer in new_model.layers[:6]]
